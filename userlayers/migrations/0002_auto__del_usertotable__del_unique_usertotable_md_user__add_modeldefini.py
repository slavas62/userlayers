...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ModelDefinition'
        db.create_table(u'userlayers_modeldefinition', (
            (u'modeldefinition_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mutant.ModelDefinition'], unique=True, primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'userlayers', ['ModelDefinition'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ModelDefinition'
        db.delete_table(u'userlayers_modeldefinition')
